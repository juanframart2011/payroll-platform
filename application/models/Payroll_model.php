<?php
	...
	public function total_hours_worked2($id,$fecha_inicial,$fecha_final) {
		$sql = 'SELECT * FROM xin_attendance_time WHERE employee_id = ? and attendance_date >= ? and attendance_date <= ?';
		$binds = array($id, $fecha_inicial, $fecha_final);
		$query = $this->db->query($sql, $binds);
		return $query;
	}
	...
	public function read_make_payment_payslip_check($employee_id,$p_fecha_inicial, $p_fecha_final) {
	
		$sql = 'SELECT * FROM xin_salary_payslips WHERE employee_id = ? and fecha_inicial >= ? and fecha_final <= ?';
		$binds = array($employee_id,$p_fecha_inicial, $p_fecha_final);
		$query = $this->db->query($sql, $binds);
		return $query;
	}
	public function read_make_payment_payslip_half_month_check($employee_id,$p_fecha_inicial, $p_fecha_final) {
	
		$sql = "SELECT * FROM xin_salary_payslips WHERE is_half_monthly_payroll = '1' and employee_id = ? and fecha_inicial >= ? and fecha_final <= ?";
		$binds = array($employee_id,$p_fecha_inicial, $p_fecha_final);
		$query = $this->db->query($sql, $binds);
		return $query;
	}
	
	public function read_make_payment_payslip_half_month_check_last($employee_id,$p_fecha_inicial, $p_fecha_final) {
	
		$sql = "SELECT * FROM xin_salary_payslips WHERE is_half_monthly_payroll = '1' and employee_id = ? and fecha_inicial >= ? and fecha_final <= ? order by payslip_id desc";
		$binds = array($employee_id,$p_fecha_inicial, $p_fecha_final);
		$query = $this->db->query($sql, $binds);
		return $query->result();
	}
	public function read_make_payment_payslip_half_month_check_first($employee_id,$p_fecha_inicial, $p_fecha_final) {
	
		$sql = "SELECT * FROM xin_salary_payslips WHERE is_half_monthly_payroll = '1' and employee_id = ? and fecha_inicial >= ? and fecha_final <= ? order by payslip_id asc";
		$binds = array($employee_id,$p_fecha_inicial, $p_fecha_final);
		$query = $this->db->query($sql, $binds);
		var_dump($query);
		return $query->result();
	...
	public function read_make_payment_payslip($employee_id,$p_fecha_inicial, $p_fecha_final) {
	...
	public function read_count_make_payment_payslip($employee_id,$p_fecha_inicial, $p_fecha_final) {
