...
$pay_fecha_inicial= strtotime($this->input->get('fecha_inicial'));
$pay_fecha_final= strtotime($this->input->get('fecha_final'));
   ...
   <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="hidden" value="<?php echo $this->input->get('fecha_inicial');?>" name="fecha_inicial" id="fecha_inicial">
          <input type="hidden" value="<?php echo $this->input->get('fecha_final');?>" name="fecha_final" id="fecha_final">
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <span><strong>NOTA:</strong> <?php echo $this->lang->line('xin_payroll_total_allowance');?>,<?php echo $this->lang->line('xin_hr_commissions');?>,<?php echo $this->lang->line('xin_payroll_total_loan');?>,<?php echo $this->lang->line('xin_payroll_total_overtime');?>,<?php echo $this->lang->line('xin_employee_set_statutory_deductions');?>,<?php echo $this->lang->line('xin_employee_set_other_payment');?> no puede ser editado.</span>
        </div>
      </div>
    </div> 
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("admin/payroll/payslip_list") ?>?employee_id=0&company_id=<?php echo $company_id;?>&fecha_inicial=<?php echo $this->input->get('fecha_inicial');?>&fecha_final=<?php echo $this->input->get('fecha_final');?>",
							type : 'GET'
						},
...
$payment_fecha_inicial= $this->input->get("fecha_inicial");
$payment_fecha_final= $this->input->get("fecha_final");
...
//overtime request
$overtime_count2 = $this->Overtime_request_model->get_overtime_request_count($euser_id,$this->input->get('pay_date'));
$overtime_count = $this->Overtime_request_model->get_overtime_request_count2($euser_id,$this->input->get('fecha_inicial'),$this->input->get('fecha_final'));
$re_hrs_old_int1 = 0;
...
$result2 = $this->Payroll_model->total_hours_worked($euser_id,$pay_date);
...
<?php echo form_open('admin/payroll/add_pay_hourly/', $attributes, $hidden);?>
   ...
   <?php
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <span><strong>NOTA:</strong> <?php echo $this->lang->line('xin_payroll_total_allowance');?>, <?php echo $this->lang->line('xin_hr_commissions');?>, <?php echo $this->lang->line('xin_payroll_total_loan');?>, <?php echo $this->lang->line('xin_payroll_total_overtime');?>, <?php echo $this->lang->line('xin_employee_set_statutory_deductions');?>, <?php echo $this->lang->line('xin_employee_set_other_payment');?>, ésta información no puede ser editada.</span>
        </div>
      </div>
    </div> 
    <div class="form-actions box-footer"> <?php echo form_button(array('name' => 'hrsale_form', 'type' => 'submit', 'class' => $this->Xin_model->form_button_class(), 'content' => '<i class="fa fa fa-check-square-o"></i> '.$this->lang->line('xin_pay'))); ?> </div>
