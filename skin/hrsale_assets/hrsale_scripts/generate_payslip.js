...
$.ajax({
	...
	type: "GET",
	data: 'jd=1&is_ajax=11&mode=not_paid&data=hourly_payslip&type=read_hourly_payment&employee_id='+employee_id+'&pay_date='+payment_date+'&company_id='+company_id+"&fecha_inicial="+fecha_inicial+"&fecha_final="+fecha_final,
	success: function (response) {
		if(response) {
...
$.ajax({
	...
	type: "GET",
	data: 'jd=1&is_ajax=11&data=payment&type=monthly_payment&employee_id='+employee_id+'&pay_date='+payment_date+'&company_id='+company_id+"&fecha_inicial="+fecha_inicial+"&fecha_final="+fecha_final,
	success: function (response) {
		if(response) {
...
$.ajax({
	...
	type: "GET",
	data: 'jd=1&is_ajax=11&data=hourly_payment&type=fhourly_payment&employee_id='+employee_id+'&pay_date='+payment_date+'&company_id='+company_id+"&fecha_inicial="+fecha_inicial+"&fecha_final="+fecha_final,
	success: function (response) {
		if(response) {
